...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_iso(
    ...
    KC_ESC,  KC_LSFT, KC_NUBS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP,   KC_PGDN,
    KC_F16,  KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                    _______, _______, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
  ),
