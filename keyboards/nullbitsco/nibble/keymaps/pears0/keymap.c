...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_MA] = LAYOUT_iso(
    ...
    KC_F16,  KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                    MO(_FN1), MO(_FN2), KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
  ),
  [_FN1] = LAYOUT_iso(
  ...
  [_NL] = LAYOUT_iso(
    ...
    KC_TRANS, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______,                            _______,                   _______, _______, _______, _______, _______, _______
 ),
